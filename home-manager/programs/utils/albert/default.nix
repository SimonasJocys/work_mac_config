...
{
  rofiShowEspanso = "/opt/homebrew/Caskroom/albert/0.31.1/Albert.app/Contents/Resources/python/plugins/albert_espanso/__init__.py";



  home.file."${rofiSearch}" = { #according to https://github.com/Mr-Aaryan/rofi-drun-search-web
    executable = true;
    text = ''
# -*- coding: utf-8 -*-
from albert import *
